...
public class VGIExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VGIDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new VGIStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VGIDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VGIDateTimeConverter dateTimeConverter = new VGIStandardDateTimeConverter();

    public VGIExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VGIExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VGIMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VGIHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VGIExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VGIHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
