...
public class VGIKPSPublicSoap
{
    ...
    public VGIKPSPublicSoap(){}

    public VGIKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VGIKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VGIExtendedSoapSerializationEnvelope envelope= new VGIExtendedSoapSerializationEnvelope(VGIExtendedSoapSerializationEnvelope.VER11);
